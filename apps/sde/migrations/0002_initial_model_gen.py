# Generated by Django 5.2.6 on 2025-09-23 04:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [
                    models.Index(
                        fields=['item_id'], name='sde_invposi_item_id_b49cab_idx'
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'indexes': [
                    models.Index(
                        fields=['region_id'], name='sde_univers_region__566e7b_idx'
                    ),
                    models.Index(
                        fields=['constellation_id'],
                        name='sde_univers_constel_817805_idx',
                    ),
                    models.Index(
                        fields=['solar_system_id'],
                        name='sde_univers_solar_s_1feafa_idx',
                    ),
                    models.Index(
                        fields=['planet_id'], name='sde_univers_planet__757ca6_idx'
                    ),
                    models.Index(fields=['moons'], name='sde_univers_moons_5e03ba_idx'),
                    models.Index(
                        fields=['asteroid_belts'], name='sde_univers_asteroi_8e3a07_idx'
                    ),
                ],
                'unique_together': {
                    ('region_id', 'constellation_id', 'solar_system_id', 'planet_id')
                },
            },
        ),
    ]
