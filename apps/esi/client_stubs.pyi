...
class GetAlliancesAllianceIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[AlliancesAllianceIdGet]:
        """Public information about an alliance"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[AlliancesAllianceIdGet]]:
        """Public information about an alliance"""
        ...
...
class GetAlliancesAllianceIdIconsOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[AlliancesAllianceIdIconsGet]:
        """Get the icon urls for a alliance  This route expires daily at 11:05"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[AlliancesAllianceIdIconsGet]]:
        """Get the icon urls for a alliance  This route expires daily at 11:05"""
        ...
...
class GetCharactersCharacterIdCalendarEventIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CharactersCharacterIdCalendarEventIdGet]:
        """Get all the information for a specific event"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CharactersCharacterIdCalendarEventIdGet]]:
        """Get all the information for a specific event"""
        ...
...
class GetCharactersCharacterIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CharactersCharacterIdGet]:
        """Public information about a character"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CharactersCharacterIdGet]]:
        """Public information about a character"""
        ...
...
class GetCharactersCharacterIdFatigueOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CharactersCharacterIdFatigueGet]:
        """Return a character's jump activation and fatigue information"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CharactersCharacterIdFatigueGet]]:
        """Return a character's jump activation and fatigue information"""
        ...
...
class GetCharactersCharacterIdPortraitOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CharactersCharacterIdPortraitGet]:
        """Get portrait urls for a character  This route expires daily at 11:05"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CharactersCharacterIdPortraitGet]]:
        """Get portrait urls for a character  This route expires daily at 11:05"""
        ...
...
class GetCharactersCharacterIdRolesOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CharactersCharacterIdRolesGet]:
        """Returns a character's corporation roles"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CharactersCharacterIdRolesGet]]:
        """Returns a character's corporation roles"""
        ...
...
class GetCharactersCharacterIdClonesOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CharactersCharacterIdClonesGet]:
        """A list of the character's clones"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CharactersCharacterIdClonesGet]]:
        """A list of the character's clones"""
        ...
...
class GetCorporationsCorporationIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CorporationsCorporationIdGet]:
        """Public information about a corporation"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CorporationsCorporationIdGet]]:
        """Public information about a corporation"""
        ...
...
class GetCorporationsCorporationIdDivisionsOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CorporationsCorporationIdDivisionsGet]:
        """Return corporation hangar and wallet division names, only show if a division is not using the default name"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CorporationsCorporationIdDivisionsGet]]:
        """Return corporation hangar and wallet division names, only show if a division is not using the default name"""
        ...
...
class GetCorporationsCorporationIdIconsOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CorporationsCorporationIdIconsGet]:
        """Get the icon urls for a corporation"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CorporationsCorporationIdIconsGet]]:
        """Get the icon urls for a corporation"""
        ...
...
class GetCorporationsCorporationIdStarbasesStarbaseIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CorporationsCorporationIdStarbasesStarbaseIdGet]:
        """Returns various settings and fuels of a starbase (POS)"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CorporationsCorporationIdStarbasesStarbaseIdGet]]:
        """Returns various settings and fuels of a starbase (POS)"""
        ...
...
class GetCorporationsProjectsContributionOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CorporationsProjectsContribution]:
        """Show your contribution to a corporation project."""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CorporationsProjectsContribution]]:
        """Show your contribution to a corporation project."""
        ...
...
class GetCorporationsProjectsContributorsOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CorporationsProjectsContributors]:
        """Listing of all contributors to a corporation project."""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CorporationsProjectsContributors]]:
        """Listing of all contributors to a corporation project."""
        ...
...
class GetCorporationsProjectsDetailOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CorporationsProjectsDetail]:
        """Get the details of a corporation project."""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CorporationsProjectsDetail]]:
        """Get the details of a corporation project."""
        ...
...
class GetCorporationsProjectsListingOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CorporationsProjectsListing]:
        """Listing of all (active) corporation projects."""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CorporationsProjectsListing]]:
        """Listing of all (active) corporation projects."""
        ...
...
class GetDogmaAttributesAttributeIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[DogmaAttributesAttributeIdGet]:
        """Get information on a dogma attribute  This route expires daily at 11:05"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[DogmaAttributesAttributeIdGet]]:
        """Get information on a dogma attribute  This route expires daily at 11:05"""
        ...
...
class GetDogmaDynamicItemsTypeIdItemIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[DogmaDynamicItemsTypeIdItemIdGet]:
        """Returns info about a dynamic item resulting from mutation with a mutaplasmid.  This route expires daily at 11:05"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[DogmaDynamicItemsTypeIdItemIdGet]]:
        """Returns info about a dynamic item resulting from mutation with a mutaplasmid.  This route expires daily at 11:05"""
        ...
...
class GetDogmaEffectsEffectIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[DogmaEffectsEffectIdGet]:
        """Get information on a dogma effect  This route expires daily at 11:05"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[DogmaEffectsEffectIdGet]]:
        """Get information on a dogma effect  This route expires daily at 11:05"""
        ...
...
class GetCharactersCharacterIdFwStatsOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CharactersCharacterIdFwStatsGet]:
        """Statistical overview of a character involved in faction warfare  This route expires daily at 11:05"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CharactersCharacterIdFwStatsGet]]:
        """Statistical overview of a character involved in faction warfare  This route expires daily at 11:05"""
        ...
...
class GetCorporationsCorporationIdFwStatsOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CorporationsCorporationIdFwStatsGet]:
        """Statistics about a corporation involved in faction warfare  This route expires daily at 11:05"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CorporationsCorporationIdFwStatsGet]]:
        """Statistics about a corporation involved in faction warfare  This route expires daily at 11:05"""
        ...
...
class GetFwLeaderboardsOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[FwLeaderboardsGet]:
        """Top 4 leaderboard of factions for kills and victory points separated by total, last week and yesterday  This route expires daily at 11:05"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[FwLeaderboardsGet]]:
        """Top 4 leaderboard of factions for kills and victory points separated by total, last week and yesterday  This route expires daily at 11:05"""
        ...
...
class GetFwLeaderboardsCharactersOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[FwLeaderboardsCharactersGet]:
        """Top 100 leaderboard of pilots for kills and victory points separated by total, last week and yesterday  This route expires daily at 11:05"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[FwLeaderboardsCharactersGet]]:
        """Top 100 leaderboard of pilots for kills and victory points separated by total, last week and yesterday  This route expires daily at 11:05"""
        ...
...
class GetFwLeaderboardsCorporationsOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[FwLeaderboardsCorporationsGet]:
        """Top 10 leaderboard of corporations for kills and victory points separated by total, last week and yesterday  This route expires daily at 11:05"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[FwLeaderboardsCorporationsGet]]:
        """Top 10 leaderboard of corporations for kills and victory points separated by total, last week and yesterday  This route expires daily at 11:05"""
        ...
...
class PostCharactersCharacterIdFittingsOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CharactersCharacterIdFittingsPost]:
        """Save a new fitting for a character"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CharactersCharacterIdFittingsPost]]:
        """Save a new fitting for a character"""
        ...
...
class GetCharactersCharacterIdFleetOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CharactersCharacterIdFleetGet]:
        """Return the fleet ID the character is in, if any."""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CharactersCharacterIdFleetGet]]:
        """Return the fleet ID the character is in, if any."""
        ...
...
class GetFleetsFleetIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[FleetsFleetIdGet]:
        """Return details about a fleet"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[FleetsFleetIdGet]]:
        """Return details about a fleet"""
        ...
...
class PostFleetsFleetIdWingsOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[FleetsFleetIdWingsPost]:
        """Create a new wing in a fleet"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[FleetsFleetIdWingsPost]]:
        """Create a new wing in a fleet"""
        ...
...
class PostFleetsFleetIdWingsWingIdSquadsOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[FleetsFleetIdWingsWingIdSquadsPost]:
        """Create a new squad in a fleet"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[FleetsFleetIdWingsWingIdSquadsPost]]:
        """Create a new squad in a fleet"""
        ...
...
class GetKillmailsKillmailIdKillmailHashOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[KillmailsKillmailIdKillmailHashGet]:
        """Return a single killmail from its ID and hash"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[KillmailsKillmailIdKillmailHashGet]]:
        """Return a single killmail from its ID and hash"""
        ...
...
class GetCharactersCharacterIdLocationOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CharactersCharacterIdLocationGet]:
        """Information about the characters current location. Returns the current solar system id, and also the current station or structure ID if applicable"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CharactersCharacterIdLocationGet]]:
        """Information about the characters current location. Returns the current solar system id, and also the current station or structure ID if applicable"""
        ...
...
class GetCharactersCharacterIdOnlineOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CharactersCharacterIdOnlineGet]:
        """Checks if the character is currently online"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CharactersCharacterIdOnlineGet]]:
        """Checks if the character is currently online"""
        ...
...
class GetCharactersCharacterIdShipOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CharactersCharacterIdShipGet]:
        """Get the current ship type, name and id"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CharactersCharacterIdShipGet]]:
        """Get the current ship type, name and id"""
        ...
...
class GetCharactersCharacterIdMailLabelsOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CharactersCharacterIdMailLabelsGet]:
        """Return a list of the users mail labels, unread counts for each label and a total unread count."""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CharactersCharacterIdMailLabelsGet]]:
        """Return a list of the users mail labels, unread counts for each label and a total unread count."""
        ...
...
class GetCharactersCharacterIdMailMailIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CharactersCharacterIdMailMailIdGet]:
        """Return the contents of an EVE mail"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CharactersCharacterIdMailMailIdGet]]:
        """Return the contents of an EVE mail"""
        ...
...
class GetMarketsGroupsMarketGroupIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[MarketsGroupsMarketGroupIdGet]:
        """Get information on an item group  This route expires daily at 11:05"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[MarketsGroupsMarketGroupIdGet]]:
        """Get information on an item group  This route expires daily at 11:05"""
        ...
...
class GetMetaCompatibilityDatesOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[MetaCompatibilityDates]:
        """Get a list of compatibility dates."""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[MetaCompatibilityDates]]:
        """Get a list of compatibility dates."""
        ...
...
class GetCharactersCharacterIdPlanetsPlanetIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CharactersCharacterIdPlanetsPlanetIdGet]:
        """Returns full details on the layout of a single planetary colony, including links, pins and routes. Note: Planetary information is only recalculated when the colony is viewed through the client. Information will not update until this criteria is met."""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CharactersCharacterIdPlanetsPlanetIdGet]]:
        """Returns full details on the layout of a single planetary colony, including links, pins and routes. Note: Planetary information is only recalculated when the colony is viewed through the client. Information will not update until this criteria is met."""
        ...
...
class GetUniverseSchematicsSchematicIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[UniverseSchematicsSchematicIdGet]:
        """Get information on a planetary factory schematic"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[UniverseSchematicsSchematicIdGet]]:
        """Get information on a planetary factory schematic"""
        ...
...
class GetCharactersCharacterIdSearchOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CharactersCharacterIdSearchGet]:
        """Search for entities that match a given sub-string."""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CharactersCharacterIdSearchGet]]:
        """Search for entities that match a given sub-string."""
        ...
...
class GetCharactersCharacterIdAttributesOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CharactersCharacterIdAttributesGet]:
        """Return attributes of a character"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CharactersCharacterIdAttributesGet]]:
        """Return attributes of a character"""
        ...
...
class GetCharactersCharacterIdSkillsOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[CharactersCharacterIdSkillsGet]:
        """List all trained skills for the given character"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[CharactersCharacterIdSkillsGet]]:
        """List all trained skills for the given character"""
        ...
...
class GetUniverseAsteroidBeltsAsteroidBeltIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[UniverseAsteroidBeltsAsteroidBeltIdGet]:
        """Get information on an asteroid belt  This route expires daily at 11:05"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[UniverseAsteroidBeltsAsteroidBeltIdGet]]:
        """Get information on an asteroid belt  This route expires daily at 11:05"""
        ...
...
class GetUniverseCategoriesCategoryIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[UniverseCategoriesCategoryIdGet]:
        """Get information of an item category  This route expires daily at 11:05"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[UniverseCategoriesCategoryIdGet]]:
        """Get information of an item category  This route expires daily at 11:05"""
        ...
...
class GetUniverseConstellationsConstellationIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[UniverseConstellationsConstellationIdGet]:
        """Get information on a constellation  This route expires daily at 11:05"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[UniverseConstellationsConstellationIdGet]]:
        """Get information on a constellation  This route expires daily at 11:05"""
        ...
...
class GetUniverseGraphicsGraphicIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[UniverseGraphicsGraphicIdGet]:
        """Get information on a graphic  This route expires daily at 11:05"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[UniverseGraphicsGraphicIdGet]]:
        """Get information on a graphic  This route expires daily at 11:05"""
        ...
...
class GetUniverseGroupsGroupIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[UniverseGroupsGroupIdGet]:
        """Get information on an item group  This route expires daily at 11:05"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[UniverseGroupsGroupIdGet]]:
        """Get information on an item group  This route expires daily at 11:05"""
        ...
...
class GetUniverseMoonsMoonIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[UniverseMoonsMoonIdGet]:
        """Get information on a moon  This route expires daily at 11:05"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[UniverseMoonsMoonIdGet]]:
        """Get information on a moon  This route expires daily at 11:05"""
        ...
...
class GetUniversePlanetsPlanetIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[UniversePlanetsPlanetIdGet]:
        """Get information on a planet  This route expires daily at 11:05"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[UniversePlanetsPlanetIdGet]]:
        """Get information on a planet  This route expires daily at 11:05"""
        ...
...
class GetUniverseRegionsRegionIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[UniverseRegionsRegionIdGet]:
        """Get information on a region  This route expires daily at 11:05"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[UniverseRegionsRegionIdGet]]:
        """Get information on a region  This route expires daily at 11:05"""
        ...
...
class GetUniverseStargatesStargateIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[UniverseStargatesStargateIdGet]:
        """Get information on a stargate  This route expires daily at 11:05"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[UniverseStargatesStargateIdGet]]:
        """Get information on a stargate  This route expires daily at 11:05"""
        ...
...
class GetUniverseStarsStarIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[UniverseStarsStarIdGet]:
        """Get information on a star  This route expires daily at 11:05"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[UniverseStarsStarIdGet]]:
        """Get information on a star  This route expires daily at 11:05"""
        ...
...
class GetUniverseStationsStationIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[UniverseStationsStationIdGet]:
        """Get information on a station  This route expires daily at 11:05"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[UniverseStationsStationIdGet]]:
        """Get information on a station  This route expires daily at 11:05"""
        ...
...
class GetUniverseStructuresStructureIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[UniverseStructuresStructureIdGet]:
        """Returns information on requested structure if you are on the ACL. Otherwise, returns "Forbidden" for all inputs."""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[UniverseStructuresStructureIdGet]]:
        """Returns information on requested structure if you are on the ACL. Otherwise, returns "Forbidden" for all inputs."""
        ...
...
class GetUniverseSystemsSystemIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[UniverseSystemsSystemIdGet]:
        """Get information on a solar system.  This route expires daily at 11:05"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[UniverseSystemsSystemIdGet]]:
        """Get information on a solar system.  This route expires daily at 11:05"""
        ...
...
class GetUniverseTypesTypeIdOperation(ESIClientOperation):
    ...
    def results(
        ...
        use_cache: bool = True,
        **extra,
    ) -> List[UniverseTypesTypeIdGet]:
        """Get information on a type  This route expires daily at 11:05"""
        ...

    def results_localized(
        self, languages: List[str] | str | None = None, **extra
    ) -> dict[str, List[UniverseTypesTypeIdGet]]:
        """Get information on a type  This route expires daily at 11:05"""
        ...
