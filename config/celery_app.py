...
def config_loggers(*args, **kwargs):
    ...
    dictConfig(settings.LOGGING)  # pyright: ignore[reportAttributeAccessIssue]


if settings.DEBUG or settings.TEST:  # pyright: ignore[reportAttributeAccessIssue]
...
if not settings.DEBUG and not settings.TEST:  # pyright: ignore[reportAttributeAccessIssue]
    ...
    app.conf.task_queues = (
        ...
        Queue(
            'esi_incursions', Exchange('esi_incursions'), routing_key='esi_incursions'
        ),
    ...
    app.conf.task_default_exchange = 'default'  # pyright: ignore[reportAttributeAccessIssue]
